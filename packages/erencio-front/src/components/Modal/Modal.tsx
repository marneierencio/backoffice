...
export const Modal = ({
  ...
  const backdropStyle: React.CSSProperties = {
    ...
    animation: `backoffice-fade-in ${tokens.duration.durationPromptly} ease-out`,
  };
  ...
  const dialogStyle: React.CSSProperties = {
    ...
    outline: 'none',
    animation: `backoffice-slide-up ${tokens.duration.durationPromptly} ease-out`,
  };
  ...
  const titleId = title ? 'backoffice-modal-title' : undefined;

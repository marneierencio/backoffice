import type { FieldType } from '@backoffice/components/FieldRenderer';
import { FieldRenderer } from '@backoffice/components/FieldRenderer';
...
export const InlineEdit = ({
  ...
  return (
    ...
    >
      ...
      {!readOnly && (
        <span
          className="backoffice-inline-edit-pencil"
          style={{
            opacity: 0,

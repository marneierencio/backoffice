...
const KEYFRAME_ID = 'backoffice-spinner-keyframe';
...
const ensureKeyframes = () => {
  ...
  style.textContent = `@keyframes backoffice-spin { to { transform: rotate(360deg); } }`;
...
export const Spinner = ({
  ...
  const spinnerStyle: React.CSSProperties = {
    ...
    borderRadius: '50%',
    animation: 'backoffice-spin 0.8s linear infinite',
  ...
  if (inline) {
    return (
      ...
      >
        ...
        <span className="backoffice-assistive-text">{label}</span>
      </span>
    );
  }

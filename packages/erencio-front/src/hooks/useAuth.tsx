import { gql, gqlWorkspace, setAuthToken } from '@backoffice/utils/api';
...
export type AuthUser = {
  ...
  lastName: string;
  email: string;
  frontendPreference: 'TWENTY' | 'BACKOFFICE';
...
export type AuthContextValue = {
  ...
  logout: () => void;
  updateFrontendPreference: (preference: 'TWENTY' | 'BACKOFFICE') => Promise<void>;
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const updateFrontendPreference = useCallback(
    async (preference: 'TWENTY' | 'BACKOFFICE') => {

...
export const DashboardPage = () => {
  ...
  const greeting = user
    ...
    : 'Welcome to Backoffice Dashboard';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: tokens.spacing.spacingXLarge }}>
      ...
      <Card
        title="Erencio.com Backoffice"
        description="You are currently using the Erencio.com Backoffice frontend."
        variant="highlight"
      >
        <div
          style={{
        ...
        >
          ...
          <div style={{ display: 'flex', gap: tokens.spacing.spacingXSmall, marginTop: tokens.spacing.spacingXSmall }}>
            ...
            <Badge label="Erencio.com Backoffice" variant="info" />

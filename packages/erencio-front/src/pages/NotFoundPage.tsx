...
export const NotFoundPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Sky background */}
        <circle cx="100" cy="100" r="100" fill="var(--backoffice-g-color-neutral-base-5, #f3f3f3)" />
        {/* Ground */}
        <ellipse cx="100" cy="160" rx="80" ry="16" fill="var(--backoffice-g-color-neutral-base-10, #e5e5e5)" />
        {/* Cactus — SLDS 2 desert / no-data illustration metaphor */}
        <rect x="95" y="100" width="10" height="50" rx="5" fill="var(--backoffice-g-color-neutral-base-30, #aeaeae)" />
        <rect x="75" y="115" width="10" height="28" rx="5" fill="var(--backoffice-g-color-neutral-base-30, #aeaeae)" />
        <rect x="75" y="115" width="30" height="10" rx="5" fill="var(--backoffice-g-color-neutral-base-30, #aeaeae)" />
        <rect x="115" y="120" width="10" height="22" rx="5" fill="var(--backoffice-g-color-neutral-base-30, #aeaeae)" />
        <rect x="95" y="120" width="30" height="10" rx="5" fill="var(--backoffice-g-color-neutral-base-30, #aeaeae)" />
        {/* 404 text in the sky */}
        <text
          x="100"
          y="80"
          ...
          fontSize="28"
          fontWeight="700"
          fill="var(--backoffice-g-color-neutral-base-50, #706e6b)"

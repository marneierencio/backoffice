    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: tokens.spacing.spacingXLarge }}>
          ...
          >
            Erencio.com Backoffice — Sign in to continue
          </p>
        </div>
        ...
        >
          This is the Erencio.com Backoffice interface. You can switch back to the default interface from your profile settings.
        </p>
      </div>
    </div>
  );

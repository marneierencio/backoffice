# Erencio.com Backoffice Fase 4 — Navegação e Produtividade: Plano de Design e Implementação

Este documento especifica os componentes, comportamentos, tokens e estrutura de página para a Fase 4 da migração Erencio.com Backoffice (Navegação e Produtividade). Todos os designs seguem os princípios do [SLDS 2](https://www.lightningdesignsystem.com/) adaptados para React, usando design tokens Erencio.com Backoffice (`--backoffice-g-*`).
...
colorTokens.stageLeadBg = 'var(--backoffice-g-color-neutral-base-10, #e5e5e5)';
colorTokens.stageQualificationBg = 'var(--backoffice-g-color-info-container, #d8edff)';
colorTokens.stageMeetingBg = 'var(--backoffice-g-color-warning-container, #fdefc8)';
colorTokens.stageProposalBg = 'var(--backoffice-g-color-brand-base-10, #e5f2ff)';
colorTokens.stageWonBg = 'var(--backoffice-g-color-success-container, #cdefc4)';
colorTokens.stageLostBg = 'var(--backoffice-g-color-error-container, #fddde3)';
```
...
--backoffice-g-color-stage-lead: #706e6b;
--backoffice-g-color-stage-qualification: #0176d3;
--backoffice-g-color-stage-meeting: #dd7a01;
--backoffice-g-color-stage-proposal: #032d60;
--backoffice-g-color-stage-won: #2e844a;
--backoffice-g-color-stage-lost: #ba0517;

/* Backdrop do menu de comandos */
--backoffice-g-color-backdrop: rgba(0, 0, 0, 0.5);
```
...
1. Todos os componentes renderizam corretamente com design tokens Erencio.com Backoffice (sem valores hardcoded)
